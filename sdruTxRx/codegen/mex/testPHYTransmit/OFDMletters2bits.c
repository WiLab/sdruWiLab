...
static const mxArray *str2double(const mxArray *b, emlrtMCInfo *location)
{
  ...
  const mxArray *m32;
  pArray = b;
  return emlrtCallMATLABR2012b(emlrtRootTLSGlobal, 1, &m32, 1, &pArray,
...
void OFDMletters2bits(const char_T str[80], real_T f[560])
{
  ...
  for (firstcol = 0; firstcol < 80; firstcol++) {
    for (i = 0; i < 7; i++) {
      ...
      i2 = 1 + i;
      emlrtDynamicBoundsCheckFastR2012b(i2, 1, bits_size_idx_1, &c_emlrtBCI,
        emlrtRootTLSGlobal);
      y = NULL;
...
void b_OFDMletters2bits(real_T f[560])
{
  ...
  for (firstcol = 0; firstcol < 80; firstcol++) {
    for (i = 0; i < 7; i++) {
      emlrtPushRtStackR2012b(&qb_emlrtRSI, emlrtRootTLSGlobal);
      i14 = 1 + i;
      emlrtDynamicBoundsCheckFastR2012b(i14, 1, bits_size_idx_1, &c_emlrtBCI,
        emlrtRootTLSGlobal);
      y = NULL;
