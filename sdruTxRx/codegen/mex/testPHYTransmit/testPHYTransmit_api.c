...
static void b_info_helper(ResolvedFunctionInfo info[485]);
static void c_info_helper(ResolvedFunctionInfo info[485]);
static void d_info_helper(ResolvedFunctionInfo info[485]);
static void e_info_helper(ResolvedFunctionInfo info[485]);
static const mxArray *emlrt_marshallOut(ResolvedFunctionInfo u[485]);
static void f_info_helper(ResolvedFunctionInfo info[485]);
static void g_info_helper(ResolvedFunctionInfo info[485]);
static void h_info_helper(ResolvedFunctionInfo info[485]);
static void info_helper(ResolvedFunctionInfo info[485]);
...
static const mxArray *emlrt_marshallOut(ResolvedFunctionInfo u[485])
{
  ...
  y = NULL;
  iv133[0] = 485;
  emlrtAssign(&y, mxCreateStructArray(1, iv133, 0, NULL));
  for (i26 = 0; i26 < 485; i26++) {
    r2 = &u[i26];
    b_u = r2->context;
    b_y = NULL;
    m29 = mxCreateString(b_u);
    emlrtAssign(&b_y, m29);
    emlrtAddField(y, b_y, "context", i26);
    b_u = r2->name;
    c_y = NULL;
    m29 = mxCreateString(b_u);
    emlrtAssign(&c_y, m29);
    emlrtAddField(y, c_y, "name", i26);
    b_u = r2->dominantType;
    d_y = NULL;
    m29 = mxCreateString(b_u);
    emlrtAssign(&d_y, m29);
    emlrtAddField(y, d_y, "dominantType", i26);
    b_u = r2->resolved;
    e_y = NULL;
    m29 = mxCreateString(b_u);
    emlrtAssign(&e_y, m29);
    emlrtAddField(y, e_y, "resolved", i26);
    c_u = r2->fileTimeLo;
    f_y = NULL;
    m29 = mxCreateNumericMatrix(1, 1, mxUINT32_CLASS, mxREAL);
    *(uint32_T *)mxGetData(m29) = c_u;
    emlrtAssign(&f_y, m29);
    emlrtAddField(y, f_y, "fileTimeLo", i26);
    c_u = r2->fileTimeHi;
    g_y = NULL;
    m29 = mxCreateNumericMatrix(1, 1, mxUINT32_CLASS, mxREAL);
    *(uint32_T *)mxGetData(m29) = c_u;
    emlrtAssign(&g_y, m29);
    emlrtAddField(y, g_y, "fileTimeHi", i26);
    c_u = r2->mFileTimeLo;
    h_y = NULL;
    m29 = mxCreateNumericMatrix(1, 1, mxUINT32_CLASS, mxREAL);
    *(uint32_T *)mxGetData(m29) = c_u;
    emlrtAssign(&h_y, m29);
    emlrtAddField(y, h_y, "mFileTimeLo", i26);
    c_u = r2->mFileTimeHi;
    i_y = NULL;
    m29 = mxCreateNumericMatrix(1, 1, mxUINT32_CLASS, mxREAL);
    *(uint32_T *)mxGetData(m29) = c_u;
    emlrtAssign(&i_y, m29);
    emlrtAddField(y, i_y, "mFileTimeHi", i26);
  }
...
static void f_info_helper(ResolvedFunctionInfo info[485])
{
  ...
  info[365].context =
    "[E]/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/CreateTXRX.m";
...
static void g_info_helper(ResolvedFunctionInfo info[485])
{
  ...
  info[440].context =
    "[E]/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/testPHYTransmit.m";
  info[440].name = "PHYTransmit";
  info[440].dominantType = "comm.SDRuTransmitter";
  info[440].resolved =
  ...
  info[441].context =
    "[E]/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/PHYTransmit.m";
  info[441].name = "generateOFDMSignal_TX2";
...
static void h_info_helper(ResolvedFunctionInfo info[485])
{
  info[448].context =
    "[C]/home/sdruser/git/traviscollins/sdruWiLab/sdru/+comm/SDRuTransmitter.p";
  info[448].name = "openDataConnection";
  ...
  info[451].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/char.m";
  info[451].fileTimeLo = 1319751568U;
  ...
  info[452].fileTimeLo = 1395280237U;
  ...
  info[453].fileTimeLo = 1395280237U;
  ...
  info[457].resolved =
    "[N]/home/sdruser/git/traviscollins/sdruWiLab/sdru/usrp_uhd_mapi/UsrpReportMethodEnumT.m";
  info[457].fileTimeLo = 1395280237U;
  ...
  info[464].context =
    "[C]/home/sdruser/git/traviscollins/sdruWiLab/sdru/+comm/SDRuTransmitter.p";
  info[464].name = "sendComplexInt16Data";
  ...
  info[468].context =
    "[C]/home/sdruser/git/traviscollins/sdruWiLab/sdru/+comm/SDRuTransmitter.p";
  info[468].name = "sendComplexSingleData";
  ...
  info[472].fileTimeLo = 1395280237U;
  info[472].fileTimeHi = 0U;
  info[472].mFileTimeLo = 0U;
  info[472].mFileTimeHi = 0U;
  info[473].context =
    "[E]/home/sdruser/git/traviscollins/sdruWiLab/sdru/usrp_uhd_mapi/sendComplexDoubleData.m";
  info[473].name = "mapiPrivate";
  info[473].dominantType = "DataPortDataTypeCapiEnumT";
  info[473].resolved =
    "[E]/home/sdruser/git/traviscollins/sdruWiLab/sdru/usrp_uhd_mapi/mapiPrivate.m";
  info[473].fileTimeLo = 1395280237U;
  info[473].fileTimeHi = 0U;
  info[473].mFileTimeLo = 0U;
  info[473].mFileTimeHi = 0U;
  info[474].context =
    "[C]/home/sdruser/git/traviscollins/sdruWiLab/sdru/+comm/SDRuTransmitter.p";
  info[474].name = "UsrpErrorCapiEnumT";
  info[474].dominantType = "";
  info[474].resolved =
    "[N]/home/sdruser/git/traviscollins/sdruWiLab/sdru/usrp_uhd_mapi/UsrpErrorCapiEnumT.m";
  info[474].fileTimeLo = 1395280237U;
  ...
  info[475].context =
    "[C]/home/sdruser/git/traviscollins/sdruWiLab/sdru/+comm/SDRuTransmitter.p";
  info[475].name = "error";
  info[475].dominantType = "char";
  info[475].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/lang/error.m";
  info[475].fileTimeLo = 1319751566U;
  info[475].fileTimeHi = 0U;
  info[475].mFileTimeLo = 0U;
  info[475].mFileTimeHi = 0U;
  info[476].context =
    "[C]/home/sdruser/git/traviscollins/sdruWiLab/sdru/+comm/SDRuReceiver.p";
  info[476].name = "DataPortDataTypeCapiEnumT";
  info[476].dominantType = "";
  info[476].resolved =
    "[N]/home/sdruser/git/traviscollins/sdruWiLab/sdru/usrp_uhd_mapi/DataPortDataTypeCapiEnumT.m";
  info[476].fileTimeLo = 1395280237U;
  info[476].fileTimeHi = 0U;
  info[476].mFileTimeLo = 0U;
  info[476].mFileTimeHi = 0U;
  info[477].context =
    "[C]/home/sdruser/git/traviscollins/sdruWiLab/sdru/+comm/SDRuReceiver.p";
  info[477].name = "openDataConnection";
  info[477].dominantType = "BoardIdCapiEnumT";
  info[477].resolved =
    "[E]/home/sdruser/git/traviscollins/sdruWiLab/sdru/usrp_uhd_mapi/openDataConnection.m";
  info[477].fileTimeLo = 1395280237U;
  info[477].fileTimeHi = 0U;
  info[477].mFileTimeLo = 0U;
  info[477].mFileTimeHi = 0U;
  info[478].context =
    "[C]/home/sdruser/git/traviscollins/sdruWiLab/sdru/+comm/SDRuReceiver.p";
  info[478].name = "mpower";
  info[478].dominantType = "double";
  info[478].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  info[478].fileTimeLo = 1286840442U;
  info[478].fileTimeHi = 0U;
  info[478].mFileTimeLo = 0U;
  info[478].mFileTimeHi = 0U;
  info[479].context =
    "[C]/home/sdruser/git/traviscollins/sdruWiLab/sdru/+comm/SDRuReceiver.p";
  info[479].name = "mrdivide";
  info[479].dominantType = "double";
  info[479].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p";
  info[479].fileTimeLo = 1357973148U;
  info[479].fileTimeHi = 0U;
  info[479].mFileTimeLo = 1319751566U;
  info[479].mFileTimeHi = 0U;
  info[480].context =
    "[C]/home/sdruser/git/traviscollins/sdruWiLab/sdru/+comm/SDRuReceiver.p";
  info[480].name = "receiveData";
  info[480].dominantType = "DataPortDataTypeCapiEnumT";
  info[480].resolved =
    "[E]/home/sdruser/git/traviscollins/sdruWiLab/sdru/usrp_uhd_mapi/receiveData.m";
  info[480].fileTimeLo = 1395280237U;
  info[480].fileTimeHi = 0U;
  info[480].mFileTimeLo = 0U;
  info[480].mFileTimeHi = 0U;
  info[481].context =
    "[E]/home/sdruser/git/traviscollins/sdruWiLab/sdru/usrp_uhd_mapi/receiveData.m";
  info[481].name = "mapiPrivate";
  info[481].dominantType = "DataPortDataTypeCapiEnumT";
  info[481].resolved =
    "[E]/home/sdruser/git/traviscollins/sdruWiLab/sdru/usrp_uhd_mapi/mapiPrivate.m";
  info[481].fileTimeLo = 1395280237U;
  info[481].fileTimeHi = 0U;
  info[481].mFileTimeLo = 0U;
  info[481].mFileTimeHi = 0U;
  info[482].context =
    "[C]/home/sdruser/git/traviscollins/sdruWiLab/sdru/+comm/SDRuReceiver.p";
  info[482].name = "UsrpErrorCapiEnumT";
  info[482].dominantType = "";
  info[482].resolved =
    "[N]/home/sdruser/git/traviscollins/sdruWiLab/sdru/usrp_uhd_mapi/UsrpErrorCapiEnumT.m";
  info[482].fileTimeLo = 1395280237U;
  ...
  info[483].context =
    "[C]/home/sdruser/git/traviscollins/sdruWiLab/sdru/+comm/SDRuReceiver.p";
  info[483].name = "error";
  info[483].dominantType = "char";
  info[483].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/lang/error.m";
  info[483].fileTimeLo = 1319751566U;
  info[483].fileTimeHi = 0U;
  info[483].mFileTimeLo = 0U;
  info[483].mFileTimeHi = 0U;
  info[484].context =
    "[C]/home/sdruser/git/traviscollins/sdruWiLab/sdru/+comm/SDRuReceiver.p";
  info[484].name = "mtimes";
  info[484].dominantType = "double";
  info[484].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  info[484].fileTimeLo = 1289541292U;
