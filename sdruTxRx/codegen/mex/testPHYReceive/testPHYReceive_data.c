...
emlrtRSInfo id_emlrtRSI = { 1, "SDRuBase",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdru/+comm/+internal/SDRuBase.p" };

emlrtRSInfo rd_emlrtRSI = { 24, "eml_all_or_any",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/eml/eml_all_or_any.m" };

emlrtRSInfo sd_emlrtRSI = { 27, "eml_all_or_any",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/eml/eml_all_or_any.m" };

emlrtRSInfo ud_emlrtRSI = { 9, "warning",
  "/opt/MATLAB/R2013a/toolbox/shared/coder/coder/+coder/+internal/warning.m" };

emlrtRSInfo vd_emlrtRSI = { 16, "eml_warning",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/eml/eml_warning.m" };

emlrtRSInfo pe_emlrtRSI = { 1, "CRCDetector",
  "/opt/MATLAB/R2013a/toolbox/comm/comm/+commcodegen/CRCDetector.p" };

emlrtRSInfo gf_emlrtRSI = { 248, "mapiPrivate",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdru/usrp_uhd_mapi/mapiPrivate.m" };

emlrtRSInfo hf_emlrtRSI = { 249, "mapiPrivate",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdru/usrp_uhd_mapi/mapiPrivate.m" };

emlrtRSInfo jf_emlrtRSI = { 71, "reportSDRuStatus",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdru/reportSDRuStatus.m" };

emlrtRSInfo lf_emlrtRSI = { 61, "reportSDRuStatus",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdru/reportSDRuStatus.m" };

emlrtRSInfo nf_emlrtRSI = { 51, "reportSDRuStatus",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdru/reportSDRuStatus.m" };

emlrtRSInfo pf_emlrtRSI = { 35, "reportSDRuStatus",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdru/reportSDRuStatus.m" };

emlrtRSInfo qf_emlrtRSI = { 17, "getSDRuDriverVersion",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdru/usrp_uhd_mapi/getSDRuDriverVersion.m"
};

emlrtRSInfo rf_emlrtRSI = { 85, "mapiPrivate",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdru/usrp_uhd_mapi/mapiPrivate.m" };

emlrtRSInfo sf_emlrtRSI = { 86, "mapiPrivate",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdru/usrp_uhd_mapi/mapiPrivate.m" };

emlrtRSInfo tf_emlrtRSI = { 87, "mapiPrivate",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdru/usrp_uhd_mapi/mapiPrivate.m" };

emlrtRSInfo pg_emlrtRSI = { 79, "colon",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/ops/colon.m" };

emlrtRSInfo qg_emlrtRSI = { 288, "colon",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/ops/colon.m" };

emlrtRSInfo rg_emlrtRSI = { 280, "colon",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/ops/colon.m" };

emlrtRSInfo sg_emlrtRSI = { 401, "colon",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/ops/colon.m" };

emlrtRSInfo tg_emlrtRSI = { 13, "rdivide",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/ops/rdivide.m" };

emlrtRSInfo dh_emlrtRSI = { 38, "eml_min_or_max",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/eml/eml_min_or_max.m" };

emlrtRSInfo ai_emlrtRSI = { 20, "sum",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/datafun/sum.m" };

emlrtRSInfo bi_emlrtRSI = { 17, "sum",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/datafun/sum.m" };

emlrtRSInfo ei_emlrtRSI = { 20, "mean",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/datafun/mean.m" };

emlrtRSInfo fi_emlrtRSI = { 17, "mean",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/datafun/mean.m" };

emlrtRSInfo li_emlrtRSI = { 104, "OFDMDemodulator",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/OFDMDemodulator.m" };

emlrtRSInfo mi_emlrtRSI = { 141, "OFDMDemodulator",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/OFDMDemodulator.m" };

emlrtRSInfo ni_emlrtRSI = { 171, "OFDMDemodulator",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/OFDMDemodulator.m" };

emlrtRSInfo oi_emlrtRSI = { 68, "reshape",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/elmat/reshape.m" };

emlrtRSInfo pi_emlrtRSI = { 66, "reshape",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/elmat/reshape.m" };

emlrtRSInfo qi_emlrtRSI = { 61, "reshape",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/elmat/reshape.m" };

emlrtRSInfo ri_emlrtRSI = { 22, "reshape",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/elmat/reshape.m" };

emlrtRSInfo ti_emlrtRSI = { 52, "eml_assert_valid_size_arg",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m" };

emlrtRSInfo vi_emlrtRSI = { 93, "reshape",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/elmat/reshape.m" };

emlrtRSInfo cj_emlrtRSI = { 1, "FIRRateConverter",
  "/opt/MATLAB/R2013a/toolbox/dsp/dsp/+dspcodegen/FIRRateConverter.p" };

emlrtRSInfo rj_emlrtRSI = { 76, "fprintf",
...
emlrtMCInfo qb_emlrtMCI = { 53, 5, "eml_assert_valid_size_arg",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m" };

emlrtMCInfo rb_emlrtMCI = { 52, 15, "eml_assert_valid_size_arg",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m" };
