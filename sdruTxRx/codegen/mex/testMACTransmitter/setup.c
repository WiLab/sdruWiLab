...
void d_Destructor(dsp_FIRRateConverter_10 *obj)
{
...
void d_Outputs(const comm_BPSKModulator_12 *obj, const real_T U0_data[563],
               const int32_T U0_size[2], creal_T Y0_data[563], int32_T Y0_size[2])
{
  int32_T inIdx;
  int32_T outIdx;
  int32_T i;
