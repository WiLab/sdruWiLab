...
static emlrtRSInfo ff_emlrtRSI = { 7, "OFDMletters2bits",
...
static emlrtRSInfo mu_emlrtRSI = { 11, "OFDMletters2bits",
  "/Users/travis/Git/sdruWiLab/sdruTxRx/private/OFDMletters2bits.m" };
  ...
  emlrtMCInfo *location)
{
  ...
  const mxArray *m28;
  pArray = b;
  return emlrtCallMATLABR2012b(sp, 1, &m28, 1, &pArray, "str2double", TRUE,
    location);
}
...
void b_OFDMletters2bits(const emlrtStack *sp, real_T f[560])
{
  ...
  int32_T i13;
  int32_T firstcol;
  static const char_T cv72[80] = { 'L', 'i', 'v', 'e', ' ', 'l', 'o', 'n', 'g',
