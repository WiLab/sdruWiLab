...
void checkIPAddressFormat(const emlrtStack *sp)
{
  ...
  emlrtDynamicBoundsCheckFastR2012b(1, 1, loop_ub, &u_emlrtBCI, sp);
  if (1 > dotIndices_data[0] - 1) {
    ii = 0;
  } else {
    i6 = dotIndices_data[0] - 1;
    ii = emlrtDynamicBoundsCheckFastR2012b(i6, 1, 12, &t_emlrtBCI, sp);
  }

  emlrtDynamicBoundsCheckFastR2012b(1, 1, loop_ub, &s_emlrtBCI, sp);
  emlrtDynamicBoundsCheckFastR2012b(2, 1, loop_ub, &r_emlrtBCI, sp);
  if (dotIndices_data[0] + 1 > dotIndices_data[1] - 1) {
    i6 = 0;
    i7 = 0;
  } else {
    i6 = dotIndices_data[0] + 1;
    i6 = emlrtDynamicBoundsCheckFastR2012b(i6, 1, 12, &q_emlrtBCI, sp) - 1;
    i7 = dotIndices_data[1] - 1;
    i7 = emlrtDynamicBoundsCheckFastR2012b(i7, 1, 12, &q_emlrtBCI, sp);
  }

  emlrtDynamicBoundsCheckFastR2012b(2, 1, loop_ub, &p_emlrtBCI, sp);
  emlrtDynamicBoundsCheckFastR2012b(3, 1, loop_ub, &o_emlrtBCI, sp);
  if (dotIndices_data[1] + 1 > dotIndices_data[2] - 1) {
    i8 = 0;
    i9 = 0;
  } else {
    i8 = dotIndices_data[1] + 1;
    i8 = emlrtDynamicBoundsCheckFastR2012b(i8, 1, 12, &n_emlrtBCI, sp) - 1;
    i9 = dotIndices_data[2] - 1;
    i9 = emlrtDynamicBoundsCheckFastR2012b(i9, 1, 12, &n_emlrtBCI, sp);
  }

  emlrtDynamicBoundsCheckFastR2012b(3, 1, loop_ub, &m_emlrtBCI, sp);
  if (dotIndices_data[2] + 1 > 12) {
    i10 = 0;
    i11 = -1;
  } else {
    i10 = dotIndices_data[2] + 1;
    i10 = emlrtDynamicBoundsCheckFastR2012b(i10, 1, 12, &l_emlrtBCI, sp) - 1;
    i11 = 11;
  }
