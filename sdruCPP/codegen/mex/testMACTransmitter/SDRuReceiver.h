...
extern void SDRuReceiver_stepImpl(testMACTransmitterStackData *SD, const emlrtStack *sp, const comm_SDRuReceiver *obj, creal_T y[5120]);
extern void b_SDRuReceiver_stepImpl(testMACTransmitterStackData *SD, const emlrtStack *sp, const comm_SDRuReceiver *obj);
#endif
