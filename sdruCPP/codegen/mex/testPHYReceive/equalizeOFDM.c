...
static emlrtRSInfo ii_emlrtRSI = { 16, "equalizeOFDM",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruCPP/private/equalizeOFDM.m" };

static emlrtRSInfo ji_emlrtRSI = { 17, "equalizeOFDM",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruCPP/private/equalizeOFDM.m" };

static emlrtRSInfo ki_emlrtRSI = { 21, "equalizeOFDM",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruCPP/private/equalizeOFDM.m" };

static emlrtRSInfo li_emlrtRSI = { 28, "equalizeOFDM",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruCPP/private/equalizeOFDM.m" };

static emlrtRSInfo mi_emlrtRSI = { 42, "equalizeOFDM",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruCPP/private/equalizeOFDM.m" };

static emlrtRSInfo ui_emlrtRSI = { 41, "eml_assert_valid_size_arg",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m" };

static emlrtRSInfo yi_emlrtRSI = { 80, "equalizeOFDM",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruCPP/private/equalizeOFDM.m" };
...
static emlrtMCInfo pb_emlrtMCI = { 42, 9, "eml_assert_valid_size_arg",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m" };

static emlrtMCInfo qb_emlrtMCI = { 41, 19, "eml_assert_valid_size_arg",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m" };
...
static emlrtBCInfo db_emlrtBCI = { -1, -1, 58, 7, "R", "equalizeOFDM",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruCPP/private/equalizeOFDM.m", 0
};
  ...
  *Rraw)
{
  ...
  int32_T exitg1;
  const mxArray *e_y;
  static const int32_T iv139[2] = { 1, 57 };

  char_T cv165[57];
  static const char_T cv166[57] = { 'C', 'o', 'd', 'e', 'r', ':', 't', 'o', 'o',
  ...
  const mxArray *f_y;
  static const int32_T iv140[2] = { 1, 21 };
  ...
  const mxArray *h_y;
  static const int32_T iv141[2] = { 1, 40 };

  char_T cv169[40];
  static const char_T cv170[40] = { 'C', 'o', 'd', 'e', 'r', ':', 'M', 'A', 'T',
    'L', 'A', 'B', ':', 'g', 'e', 't', 'R', 'e', 's', 'h', 'a', 'p', 'e', 'D',
    'i', 'm', 's', '_', 'n', 'o', 't', 'S', 'a', 'm', 'e', 'N', 'u', 'm', 'e',
    'l' };

  creal_T varargout_2[48];
  static const int16_T iv142[48] = { 11, 25, 39, 53, 75, 89, 103, 117, 139, 153,
  ...
  static const int8_T iv143[3] = { 48, 12, 1 };
  ...
  if (!obj->isReleased) {
    ...
    y = NULL;
    m41 = mxCreateCharArray(2, iv135);
    for (i = 0; i < 45; i++) {
      cv157[i] = cv158[i];
    }

    emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 45, m41, cv157);
    emlrtAssign(&y, m41);
    b_y = NULL;
    m41 = mxCreateCharArray(2, iv136);
    for (i = 0; i < 4; i++) {
      cv159[i] = cv160[i];
    }

    emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 4, m41, cv159);
    emlrtAssign(&b_y, m41);
  ...
  if (!obj->isInitialized) {
    ...
    if (!obj->isInitialized) {
      ...
      emlrtPushRtStackR2012b(&p_emlrtRSI, emlrtRootTLSGlobal);
      c_y = NULL;
      m41 = mxCreateCharArray(2, iv137);
      for (i = 0; i < 51; i++) {
        cv161[i] = cv162[i];
      }

      emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 51, m41, cv161);
      emlrtAssign(&c_y, m41);
      d_y = NULL;
      m41 = mxCreateCharArray(2, iv138);
      for (i = 0; i < 5; i++) {
        cv163[i] = cv164[i];
      }

      emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 5, m41, cv163);
      emlrtAssign(&d_y, m41);
  ...
  if (overflow) {
    ...
    e_y = NULL;
    m41 = mxCreateCharArray(2, iv139);
    for (i = 0; i < 57; i++) {
      cv165[i] = cv166[i];
    }

    emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 57, m41, cv165);
    emlrtAssign(&e_y, m41);
    b_error(b_message(e_y, &pb_emlrtMCI), &qb_emlrtMCI);
  ...
  if (2.147483647E+9 >= tmp_re) {
    ...
    f_y = NULL;
    m41 = mxCreateCharArray(2, iv140);
    for (i = 0; i < 21; i++) {
      cv167[i] = cv168[i];
    }

    emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 21, m41, cv167);
    emlrtAssign(&f_y, m41);
    b_error(b_message(f_y, &rb_emlrtMCI), &sb_emlrtMCI);
  ...
  if (b_x->size[0] == sz[0] * 12) {
    ...
    h_y = NULL;
    m41 = mxCreateCharArray(2, iv141);
    for (i = 0; i < 40; i++) {
      cv169[i] = cv170[i];
    }

    emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 40, m41, cv169);
    emlrtAssign(&h_y, m41);
    b_error(b_message(h_y, &nb_emlrtMCI), &ob_emlrtMCI);
