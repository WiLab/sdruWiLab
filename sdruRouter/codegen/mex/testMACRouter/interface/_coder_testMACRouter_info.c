...
/* Include files */
#include "_coder_testMACRouter_info.h"
...
static void info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/Volumes/git/traviscollins/sdruWiLab/sdruRouter/testMACRouter.m"),
                "context", 0);
...
static void h_info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/Volumes/git/traviscollins/sdruWiLab/sdruRouter/testMACRouter.m"),
                "context", 467);
  emlrtAddField(*info, emlrt_marshallOut("MACLayerRouter"), "name", 467);
  emlrtAddField(*info, emlrt_marshallOut("comm.AGC"), "dominantType", 467);
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/Volumes/git/traviscollins/sdruWiLab/sdruRouter/MACLayerRouter.m"),
                "resolved", 467);
  emlrtAddField(*info, b_emlrt_marshallOut(1394158688U), "fileTimeLo", 467);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/DLLayer.m"), "resolved",
                468);
  emlrtAddField(*info, b_emlrt_marshallOut(1394152084U), "fileTimeLo", 468);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/PHYReceive.m"), "resolved",
                476);
  emlrtAddField(*info, b_emlrt_marshallOut(1394151845U), "fileTimeLo", 476);
...
static void m_info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/DLLayer.m"), "context",
                772);
  emlrtAddField(*info, emlrt_marshallOut("abs"), "name", 772);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 772);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m"), "resolved", 772);
  emlrtAddField(*info, b_emlrt_marshallOut(1363731852U), "fileTimeLo", 772);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/DLLayer.m"), "context",
                773);
  emlrtAddField(*info, emlrt_marshallOut("length"), "name", 773);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 773);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m"), "resolved", 773);
  emlrtAddField(*info, b_emlrt_marshallOut(1303167806U), "fileTimeLo", 773);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/Volumes/git/traviscollins/sdruWiLab/sdruRouter/MACLayerRouter.m"),
                "context", 774);
  emlrtAddField(*info, emlrt_marshallOut("eml_strcmp"), "name", 774);
  emlrtAddField(*info, emlrt_marshallOut(""), "dominantType", 774);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_strcmp.m"), "resolved",
                774);
  emlrtAddField(*info, b_emlrt_marshallOut(1286840400U), "fileTimeLo", 774);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/Volumes/git/traviscollins/sdruWiLab/sdruRouter/MACLayerRouter.m"),
                "context", 775);
  emlrtAddField(*info, emlrt_marshallOut("fprintf"), "name", 775);
  emlrtAddField(*info, emlrt_marshallOut("char"), "dominantType", 775);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/lang/fprintf.m"), "resolved", 775);
  emlrtAddField(*info, b_emlrt_marshallOut(1368204632U), "fileTimeLo", 775);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/lang/fprintf.m!get_arg_info_struct"),
                "context", 776);
  emlrtAddField(*info, emlrt_marshallOut("eml_is_integer_class"), "name", 776);
  emlrtAddField(*info, emlrt_marshallOut("char"), "dominantType", 776);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_integer_class.m"),
                "resolved", 776);
  emlrtAddField(*info, b_emlrt_marshallOut(1286840382U), "fileTimeLo", 776);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/lang/fprintf.m!check_type"),
                "context", 777);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.assert"), "name", 777);
  emlrtAddField(*info, emlrt_marshallOut("char"), "dominantType", 777);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/assert.m"),
                "resolved", 777);
  emlrtAddField(*info, b_emlrt_marshallOut(1363732556U), "fileTimeLo", 777);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[PE]/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/private/generateOFDMSignal_TX2.m"),
                "resolved", 784);
  emlrtAddField(*info, b_emlrt_marshallOut(1394158647U), "fileTimeLo", 784);
...
mxArray *emlrtMexFcnProperties()
{
  ...
  mxSetFieldByNumber(xEntryPoints, 0, 0, mxCreateString("testMACRouter"));
...
/* End of code generation (_coder_testMACRouter_info.c) */
