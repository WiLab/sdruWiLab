...
static emlrtRSInfo emlrtRSI = { 30, "testMACRouter",
  "/Volumes/git/traviscollins/sdruWiLab/sdruRouter/testMACRouter.m" };

static emlrtRSInfo b_emlrtRSI = { 5, "testMACRouter",
  "/Volumes/git/traviscollins/sdruWiLab/sdruRouter/testMACRouter.m" };
...
static emlrtRSInfo pl_emlrtRSI = { 21, "MACLayerRouter",
  "/Volumes/git/traviscollins/sdruWiLab/sdruRouter/MACLayerRouter.m" };

static emlrtRSInfo ql_emlrtRSI = { 39, "MACLayerRouter",
  "/Volumes/git/traviscollins/sdruWiLab/sdruRouter/MACLayerRouter.m" };

static emlrtRSInfo rl_emlrtRSI = { 41, "MACLayerRouter",
  "/Volumes/git/traviscollins/sdruWiLab/sdruRouter/MACLayerRouter.m" };

static emlrtRSInfo sl_emlrtRSI = { 42, "MACLayerRouter",
  "/Volumes/git/traviscollins/sdruWiLab/sdruRouter/MACLayerRouter.m" };

static emlrtRSInfo tl_emlrtRSI = { 45, "MACLayerRouter",
  "/Volumes/git/traviscollins/sdruWiLab/sdruRouter/MACLayerRouter.m" };

static emlrtRSInfo ul_emlrtRSI = { 47, "MACLayerRouter",
  "/Volumes/git/traviscollins/sdruWiLab/sdruRouter/MACLayerRouter.m" };

static emlrtRSInfo vl_emlrtRSI = { 48, "MACLayerRouter",
  "/Volumes/git/traviscollins/sdruWiLab/sdruRouter/MACLayerRouter.m" };

static emlrtRSInfo wl_emlrtRSI = { 49, "MACLayerRouter",
  "/Volumes/git/traviscollins/sdruWiLab/sdruRouter/MACLayerRouter.m" };

static emlrtRSInfo xl_emlrtRSI = { 59, "MACLayerRouter",
  "/Volumes/git/traviscollins/sdruWiLab/sdruRouter/MACLayerRouter.m" };

static emlrtRSInfo yl_emlrtRSI = { 61, "MACLayerRouter",
  "/Volumes/git/traviscollins/sdruWiLab/sdruRouter/MACLayerRouter.m" };

static emlrtRSInfo am_emlrtRSI = { 63, "MACLayerRouter",
  "/Volumes/git/traviscollins/sdruWiLab/sdruRouter/MACLayerRouter.m" };

static emlrtRSInfo bm_emlrtRSI = { 64, "MACLayerRouter",
  "/Volumes/git/traviscollins/sdruWiLab/sdruRouter/MACLayerRouter.m" };

static emlrtRSInfo cm_emlrtRSI = { 65, "MACLayerRouter",
  "/Volumes/git/traviscollins/sdruWiLab/sdruRouter/MACLayerRouter.m" };

static emlrtRSInfo dm_emlrtRSI = { 95, "DLLayer",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/DLLayer.m" };

static emlrtRSInfo em_emlrtRSI = { 97, "DLLayer",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/DLLayer.m" };

static emlrtRSInfo fm_emlrtRSI = { 76, "DLLayer",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/DLLayer.m" };

static emlrtRSInfo gm_emlrtRSI = { 48, "DLLayer",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/DLLayer.m" };

static emlrtRSInfo hm_emlrtRSI = { 62, "DLLayer",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/DLLayer.m" };

static emlrtRSInfo im_emlrtRSI = { 64, "DLLayer",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/DLLayer.m" };

static emlrtRSInfo jm_emlrtRSI = { 116, "DLLayer",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/DLLayer.m" };

static emlrtRTEInfo b_emlrtRTEI = { 11, 5, "testMACRouter",
  "/Volumes/git/traviscollins/sdruWiLab/sdruRouter/testMACRouter.m" };

static emlrtRTEInfo c_emlrtRTEI = { 10, 5, "testMACRouter",
  "/Volumes/git/traviscollins/sdruWiLab/sdruRouter/testMACRouter.m" };

static emlrtECInfo emlrtECI = { 2, 25, 1, "testMACRouter",
  "/Volumes/git/traviscollins/sdruWiLab/sdruRouter/testMACRouter.m" };

static emlrtECInfo b_emlrtECI = { 2, 30, 9, "testMACRouter",
  "/Volumes/git/traviscollins/sdruWiLab/sdruRouter/testMACRouter.m" };

static emlrtECInfo c_emlrtECI = { 2, 32, 1, "DLLayer",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/DLLayer.m" };

static emlrtECInfo d_emlrtECI = { 2, 101, 17, "DLLayer",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/DLLayer.m" };

static emlrtBCInfo emlrtBCI = { -1, -1, 106, 28, "Response", "DLLayer",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/DLLayer.m", 0 };

static emlrtECInfo e_emlrtECI = { 2, 106, 17, "DLLayer",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/DLLayer.m" };

static emlrtECInfo f_emlrtECI = { 2, 77, 17, "DLLayer",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/DLLayer.m" };

static emlrtECInfo g_emlrtECI = { 2, 43, 17, "DLLayer",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/DLLayer.m" };

static emlrtBCInfo b_emlrtBCI = { -1, -1, 104, 39, "Response", "DLLayer",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/DLLayer.m", 0 };

static emlrtBCInfo c_emlrtBCI = { -1, -1, 105, 37, "Response", "DLLayer",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/DLLayer.m", 0 };

static emlrtBCInfo d_emlrtBCI = { -1, -1, 99, 39, "Response", "DLLayer",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/DLLayer.m", 0 };

static emlrtBCInfo e_emlrtBCI = { -1, -1, 100, 37, "Response", "DLLayer",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/DLLayer.m", 0 };

static emlrtBCInfo f_emlrtBCI = { 1, 3, 63, 79, "tx.offsetTable",
  "MACLayerRouter",
  "/Volumes/git/traviscollins/sdruWiLab/sdruRouter/MACLayerRouter.m", 0 };

static emlrtBCInfo g_emlrtBCI = { 1, 3, 47, 83, "tx.offsetTable",
  "MACLayerRouter",
  "/Volumes/git/traviscollins/sdruWiLab/sdruRouter/MACLayerRouter.m", 0 };

/* Function Definitions */
void testMACRouter(testMACRouterStackData *SD, const emlrtStack *sp, const
  ...
  while (1) {
      ...
      switch (i) {
       ...
       case 3:
        ...
        if (b_bool) {
          ...
          originNodeID = (uint8_T)
            Response_data[emlrtDynamicBoundsCheckFastR2012b(i, 1, Response_size
            [1], &b_emlrtBCI, &b_st) - 1] - 48;

          /* extract node ID and convert char to number */
          i = Response_size[1] - 1;
          destNodeID = (real_T)(uint8_T)
            Response_data[emlrtDynamicBoundsCheckFastR2012b(i, 1, Response_size
            [1], &c_emlrtBCI, &b_st) - 1] - 48.0;
          ...
          for (i = 0; i < loop_ub; i++) {
            Response_data[i] = b_Response_data[i];
          }
    ...
    if (!b_bool) {
      ...
      if (!b_bool) {
        ...
        f_fprintf(&b_st, Response_data, Response_size);
        b_st.site = &sl_emlrtRSI;
        h_fprintf(&b_st, (int16_T)originNodeID);
...
/* End of code generation (testMACRouter.c) */
