...
#ifndef __TESTMACTRANSMITTER_TYPES_H__
#define __TESTMACTRANSMITTER_TYPES_H__
...
#ifndef struct_comm_PNSequence_13
#define struct_comm_PNSequence_13
struct comm_PNSequence_13
{
...
#endif /*struct_comm_PNSequence_13*/
#ifndef typedef_comm_PNSequence_13
#define typedef_comm_PNSequence_13
typedef struct comm_PNSequence_13 comm_PNSequence_13;
#endif /*typedef_comm_PNSequence_13*/
...
#ifndef struct_comm_BPSKModulator_12
#define struct_comm_BPSKModulator_12
struct comm_BPSKModulator_12
{
    boolean_T S0_isInitialized;
    boolean_T S1_isReleased;
    real_T P0_modmap[4];
};
#endif /*struct_comm_BPSKModulator_12*/
#ifndef typedef_comm_BPSKModulator_12
#define typedef_comm_BPSKModulator_12
typedef struct comm_BPSKModulator_12 comm_BPSKModulator_12;
#endif /*typedef_comm_BPSKModulator_12*/
#ifndef typedef_commcodegen_BPSKModulator_3
#define typedef_commcodegen_BPSKModulator_3
typedef struct
{
    boolean_T isInitialized;
    boolean_T isReleased;
    uint32_T inputVarSize1[8];
    boolean_T inputDirectFeedthrough1;
    comm_BPSKModulator_12 cSFunObject;
} commcodegen_BPSKModulator_3;
#endif /*typedef_commcodegen_BPSKModulator_3*/
...
#ifndef struct_comm_CRCGenerator_11
#define struct_comm_CRCGenerator_11
struct comm_CRCGenerator_11
{
    boolean_T S0_isInitialized;
    boolean_T S1_isReleased;
    uint32_T P0_CRCTable[256];
};
#endif /*struct_comm_CRCGenerator_11*/
#ifndef typedef_comm_CRCGenerator_11
#define typedef_comm_CRCGenerator_11
typedef struct comm_CRCGenerator_11 comm_CRCGenerator_11;
#endif /*typedef_comm_CRCGenerator_11*/
#ifndef typedef_commcodegen_CRCGenerator_18
#define typedef_commcodegen_CRCGenerator_18
typedef struct
{
    boolean_T isInitialized;
    boolean_T isReleased;
    uint32_T inputVarSize1[8];
    boolean_T inputDirectFeedthrough1;
    comm_CRCGenerator_11 cSFunObject;
} commcodegen_CRCGenerator_18;
#endif /*typedef_commcodegen_CRCGenerator_18*/
...
#ifndef struct_dsp_FIRRateConverter_10
#define struct_dsp_FIRRateConverter_10
struct dsp_FIRRateConverter_10
{
    boolean_T S0_isInitialized;
    boolean_T S1_isReleased;
...
#endif /*struct_dsp_FIRRateConverter_10*/
#ifndef typedef_dsp_FIRRateConverter_10
#define typedef_dsp_FIRRateConverter_10
typedef struct dsp_FIRRateConverter_10 dsp_FIRRateConverter_10;
#endif /*typedef_dsp_FIRRateConverter_10*/
...
typedef struct
{
    ...
    uint32_T inputVarSize1[8];
    boolean_T inputDirectFeedthrough1;
    dsp_FIRRateConverter_10 cSFunObject;
...
#ifndef struct_sCeburaLI3WAhTFuhsJo6yD
#define struct_sCeburaLI3WAhTFuhsJo6yD
struct sCeburaLI3WAhTFuhsJo6yD
{
    real_T originalData[560];
    creal_T shortPreambleOFDM[64];
    creal_T completeShortPreambleOFDM[160];
    ...
    real_T receiveBufferLength;
    real_T CenterFrequency;
    real_T offsetTable[3];
    real_T nodeNum;
};
#endif /*struct_sCeburaLI3WAhTFuhsJo6yD*/
#ifndef typedef_e_struct_T
#define typedef_e_struct_T
typedef struct sCeburaLI3WAhTFuhsJo6yD e_struct_T;
#endif /*typedef_e_struct_T*/
#ifndef typedef_testMACTransmitterStackData
#define typedef_testMACTransmitterStackData
typedef struct
{
    union
    {
...
#endif
/* End of code generation (testMACTransmitter_types.h) */
