...
static emlrtRSInfo sc_emlrtRSI = { 355, "OFDMModulator",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruCPP/OFDMModulator.m" };

static emlrtRSInfo tc_emlrtRSI = { 378, "OFDMModulator",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruCPP/OFDMModulator.m" };

static emlrtRSInfo uc_emlrtRSI = { 384, "OFDMModulator",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruCPP/OFDMModulator.m" };

static emlrtRTEInfo l_emlrtRTEI = { 391, 19, "OFDMModulator",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruCPP/OFDMModulator.m" };
  ...
  creal_T yout[64])
{
  ...
  emxInit_int32_T(&r2, 1, &l_emlrtRTEI, TRUE);
  iy = r2->size[0];
  r2->size[0] = obj->pDataLinearIndices->size[0];
  emxEnsureCapacity((emxArray__common *)r2, iy, (int32_T)sizeof(int32_T),
                    &l_emlrtRTEI);
  ...
  for (iy = 0; iy < ia; iy++) {
    ...
    ib = (int32_T)emlrtIntegerCheckFastR2012b(temp_re, &emlrtDCI,
      emlrtRootTLSGlobal);
    r2->data[iy] = emlrtDynamicBoundsCheckFastR2012b(ib, 1, 64, &b_emlrtBCI,
      emlrtRootTLSGlobal);
  }
  ...
  ia = r2->size[0];
  for (iy = 0; iy < ia; iy++) {
    packedData[r2->data[iy] - 1] = dataIn[iy];
  }
