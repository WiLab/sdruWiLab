...
extern void i_SystemCore_step(testMACReceiverStackData *SD, const emlrtStack *sp, comm_SDRuTransmitter *obj, const creal_T varargin_1[38400]);
extern void j_SystemCore_step(testMACReceiverStackData *SD, const emlrtStack *sp, comm_SDRuReceiver *obj);
#endif
