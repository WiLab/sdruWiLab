...
static void b_info_helper(ResolvedFunctionInfo info[732]);
static void c_info_helper(ResolvedFunctionInfo info[732]);
static void d_info_helper(ResolvedFunctionInfo info[732]);
static void e_info_helper(ResolvedFunctionInfo info[732]);
static const mxArray *emlrt_marshallOut(ResolvedFunctionInfo u[732]);
static void f_info_helper(ResolvedFunctionInfo info[732]);
static void g_info_helper(ResolvedFunctionInfo info[732]);
static void h_info_helper(ResolvedFunctionInfo info[732]);
static void i_info_helper(ResolvedFunctionInfo info[732]);
static void info_helper(ResolvedFunctionInfo info[732]);
static void j_info_helper(ResolvedFunctionInfo info[732]);
static void k_info_helper(ResolvedFunctionInfo info[732]);
static void l_info_helper(ResolvedFunctionInfo info[732]);
...
static const mxArray *emlrt_marshallOut(ResolvedFunctionInfo u[732])
{
  ...
  y = NULL;
  iv128[0] = 732;
  emlrtAssign(&y, mxCreateStructArray(1, iv128, 0, NULL));
  for (i30 = 0; i30 < 732; i30++) {
    r2 = &u[i30];
    b_u = r2->context;
    b_y = NULL;
    m30 = mxCreateString(b_u);
    emlrtAssign(&b_y, m30);
    emlrtAddField(y, b_y, "context", i30);
    b_u = r2->name;
    c_y = NULL;
    m30 = mxCreateString(b_u);
    emlrtAssign(&c_y, m30);
    emlrtAddField(y, c_y, "name", i30);
    b_u = r2->dominantType;
    d_y = NULL;
    m30 = mxCreateString(b_u);
    emlrtAssign(&d_y, m30);
    emlrtAddField(y, d_y, "dominantType", i30);
    b_u = r2->resolved;
    e_y = NULL;
    m30 = mxCreateString(b_u);
    emlrtAssign(&e_y, m30);
    emlrtAddField(y, e_y, "resolved", i30);
    c_u = r2->fileTimeLo;
    f_y = NULL;
    m30 = mxCreateNumericMatrix(1, 1, mxUINT32_CLASS, mxREAL);
    *(uint32_T *)mxGetData(m30) = c_u;
    emlrtAssign(&f_y, m30);
    emlrtAddField(y, f_y, "fileTimeLo", i30);
    c_u = r2->fileTimeHi;
    g_y = NULL;
    m30 = mxCreateNumericMatrix(1, 1, mxUINT32_CLASS, mxREAL);
    *(uint32_T *)mxGetData(m30) = c_u;
    emlrtAssign(&g_y, m30);
    emlrtAddField(y, g_y, "fileTimeHi", i30);
    c_u = r2->mFileTimeLo;
    h_y = NULL;
    m30 = mxCreateNumericMatrix(1, 1, mxUINT32_CLASS, mxREAL);
    *(uint32_T *)mxGetData(m30) = c_u;
    emlrtAssign(&h_y, m30);
    emlrtAddField(y, h_y, "mFileTimeLo", i30);
    c_u = r2->mFileTimeHi;
    i_y = NULL;
    m30 = mxCreateNumericMatrix(1, 1, mxUINT32_CLASS, mxREAL);
    *(uint32_T *)mxGetData(m30) = c_u;
    emlrtAssign(&i_y, m30);
    emlrtAddField(y, i_y, "mFileTimeHi", i30);
  }
...
static void g_info_helper(ResolvedFunctionInfo info[732])
{
  ...
  info[440].context =
    "[E]/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/testPHYReceive.m";
  ...
  info[445].fileTimeLo = 1395280237U;
  ...
  info[447].fileTimeLo = 1395280237U;
...
static void h_info_helper(ResolvedFunctionInfo info[732])
{
  ...
  info[496].fileTimeLo = 1395280238U;
...
static void j_info_helper(ResolvedFunctionInfo info[732])
{
  ...
  info[592].fileTimeLo = 1395280238U;
  ...
  info[607].fileTimeLo = 1395280238U;
...
static void k_info_helper(ResolvedFunctionInfo info[732])
{
  ...
  info[693].fileTimeLo = 1395280238U;
...
static void l_info_helper(ResolvedFunctionInfo info[732])
{
  ...
  info[708].fileTimeLo = 1395280238U;
  ...
  info[726].context =
    "[E]/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/testPHYReceive.m";
  info[726].name = "fprintf";
  info[726].dominantType = "char";
  info[726].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/lang/fprintf.m";
  info[726].fileTimeLo = 1354862384U;
  info[726].fileTimeHi = 0U;
  info[726].mFileTimeLo = 0U;
  info[726].mFileTimeHi = 0U;
  info[727].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/lang/fprintf.m";
  info[727].name = "isequal";
  info[727].dominantType = "char";
  info[727].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  info[727].fileTimeLo = 1286840358U;
  info[727].fileTimeHi = 0U;
  info[727].mFileTimeLo = 0U;
  info[727].mFileTimeHi = 0U;
  info[728].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  info[728].name = "eml_isequal_core";
  info[728].dominantType = "char";
  info[728].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isequal_core.m";
  info[728].fileTimeLo = 1286840386U;
  ...
  info[729].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isequal_core.m!isequal_scalar";
  info[729].name = "isnan";
  info[729].dominantType = "char";
  info[729].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m";
  info[729].fileTimeLo = 1286840360U;
  info[729].fileTimeHi = 0U;
  info[729].mFileTimeLo = 0U;
  info[729].mFileTimeHi = 0U;
  info[730].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/lang/fprintf.m";
  info[730].name = "fprintf";
  info[730].dominantType = "double";
  info[730].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/lang/fprintf.m";
  info[730].fileTimeLo = 1354862384U;
  ...
  info[731].name = "coder.internal.assert";
  info[731].dominantType = "char";
  info[731].resolved =
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/assert.m";
  info[731].fileTimeLo = 1334093538U;
  ...
  [1])
{
  ...
  offset = emlrt_marshallIn(emlrtAliasP(prhs[0]), "offset");

  /* Invoke the target function */
  testPHYReceive(SD, offset);
}
