  ...
  varargin_1[563], creal_T varargout_1[563])
{
  ...
  int32_T tmp_size[2];
  creal_T tmp_data[563];
  static int32_T iv164[2] = { 563, 1 };

  b_obj = obj;
  c_Outputs(&b_obj->cSFunObject, varargin_1, iv164, tmp_data, tmp_size);
  memcpy(&varargout_1[0], &tmp_data[0], 563U * sizeof(creal_T));
}
  ...
  varargin_1[13], creal_T varargout_1[13])
{
  ...
  int32_T tmp_size[2];
  creal_T tmp_data[563];
  static int32_T iv165[2] = { 13, 1 };

  b_obj = obj;
  c_Outputs(&b_obj->cSFunObject, varargin_1, iv165, tmp_data, tmp_size);
  memcpy(&varargout_1[0], &tmp_data[0], 13U * sizeof(creal_T));
}
