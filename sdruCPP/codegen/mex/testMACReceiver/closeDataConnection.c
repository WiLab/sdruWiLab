...
static emlrtRSInfo bn_emlrtRSI = { 6, "closeDataConnection",
...
{
  const mxArray *y;
  static const int32_T iv114[2] = { 1, 6 };

  const mxArray *m20;
  char_T cv128[6];
  int32_T i;
  static const char_T cv129[6] = { 's', 'i', 'l', 'e', 'n', 't' };
  ...
  if (!isSetupsdruCalled) {
    ...
    emlrtInitCharArrayR2013a(&st, 6, m20, cv128);
    emlrtAssign(&y, m20);
  ...
  if (1 > i) {
    ...
    emlrtDynamicBoundsCheckFastR2012b(i, 1, 1024, &y_emlrtBCI, &st);
  }
}
