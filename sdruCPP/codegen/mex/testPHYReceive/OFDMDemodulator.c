...
static emlrtRSInfo wi_emlrtRSI = { 136, "OFDMDemodulator",
...
void OFDMDemodulator_setupImpl(OFDMDemodulator *obj)
{
  ...
  int32_T ii;
  int32_T idx;
  static const int8_T iv117[11] = { 0, 1, 2, 3, 4, 5, 59, 60, 61, 62, 63 };

  static const int16_T iv118[48] = { 11, 25, 39, 53, 75, 89, 103, 117, 139, 153,
