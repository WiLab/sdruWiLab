START_DIR = /Volumes/git/traviscollins/sdruWiLab/sdruRouter

MATLAB_ROOT = /Applications/MATLAB_R2013b.app
MAKEFILE = testMACRouter_mex.mk

include testMACRouter_mex.mki
...
SRC_FILES =  \
	...
	testMACRouter_api.c \
	testMACRouter_emxutil.c \
	testMACRouter_mex.c \
	_coder_testMACRouter_info.c

MEX_FILE_NAME_WO_EXT = testMACRouter_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/testMACRouter"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/testMACRouter/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/testMACRouter/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/testMACRouter/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/testMACRouter/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
