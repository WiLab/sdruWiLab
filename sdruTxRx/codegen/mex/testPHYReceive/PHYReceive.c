...
static emlrtRSInfo qe_emlrtRSI = { 99, "PHYReceive",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/PHYReceive.m" };

static emlrtRSInfo re_emlrtRSI = { 97, "PHYReceive",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/PHYReceive.m" };

static emlrtRSInfo se_emlrtRSI = { 93, "PHYReceive",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/PHYReceive.m" };

static emlrtRSInfo te_emlrtRSI = { 67, "PHYReceive",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/PHYReceive.m" };

static emlrtRSInfo ue_emlrtRSI = { 64, "PHYReceive",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/PHYReceive.m" };

static emlrtRSInfo ve_emlrtRSI = { 61, "PHYReceive",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/PHYReceive.m" };

static emlrtRSInfo we_emlrtRSI = { 47, "PHYReceive",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/PHYReceive.m" };

static emlrtRSInfo xe_emlrtRSI = { 41, "PHYReceive",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/PHYReceive.m" };

static emlrtRSInfo ye_emlrtRSI = { 33, "PHYReceive",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/PHYReceive.m" };

static emlrtRSInfo if_emlrtRSI = { 73, "reportSDRuStatus",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdru/reportSDRuStatus.m" };

static emlrtRSInfo kf_emlrtRSI = { 63, "reportSDRuStatus",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdru/reportSDRuStatus.m" };

static emlrtRSInfo mf_emlrtRSI = { 53, "reportSDRuStatus",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdru/reportSDRuStatus.m" };

static emlrtRSInfo of_emlrtRSI = { 42, "reportSDRuStatus",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdru/reportSDRuStatus.m" };

static emlrtRSInfo xf_emlrtRSI = { 172, "AGC",
  "/opt/MATLAB/R2013a/toolbox/comm/comm/+comm/AGC.m" };

static emlrtRSInfo yf_emlrtRSI = { 173, "AGC",
  "/opt/MATLAB/R2013a/toolbox/comm/comm/+comm/AGC.m" };

static emlrtRSInfo ag_emlrtRSI = { 176, "AGC",
  "/opt/MATLAB/R2013a/toolbox/comm/comm/+comm/AGC.m" };

static emlrtRSInfo bg_emlrtRSI = { 183, "AGC",
  "/opt/MATLAB/R2013a/toolbox/comm/comm/+comm/AGC.m" };

static emlrtRSInfo cg_emlrtRSI = { 184, "AGC",
  "/opt/MATLAB/R2013a/toolbox/comm/comm/+comm/AGC.m" };

static emlrtRSInfo dg_emlrtRSI = { 185, "AGC",
  "/opt/MATLAB/R2013a/toolbox/comm/comm/+comm/AGC.m" };

static emlrtRSInfo eg_emlrtRSI = { 189, "AGC",
  "/opt/MATLAB/R2013a/toolbox/comm/comm/+comm/AGC.m" };

static emlrtRSInfo fg_emlrtRSI = { 282, "AGC",
  "/opt/MATLAB/R2013a/toolbox/comm/comm/+comm/AGC.m" };

static emlrtRSInfo hg_emlrtRSI = { 28, "locateOFDMFrame_sdr",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/private/locateOFDMFrame_sdr.m"
};

static emlrtRSInfo ig_emlrtRSI = { 24, "locateOFDMFrame_sdr",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/private/locateOFDMFrame_sdr.m"
};

static emlrtRSInfo jg_emlrtRSI = { 17, "locateOFDMFrame_sdr",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/private/locateOFDMFrame_sdr.m"
};

static emlrtRSInfo kg_emlrtRSI = { 16, "locateOFDMFrame_sdr",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/private/locateOFDMFrame_sdr.m"
};

static emlrtRSInfo xh_emlrtRSI = { 17, "coarseOFDMFreqEst_sdr",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/private/coarseOFDMFreqEst_sdr.m"
};

static emlrtRSInfo yh_emlrtRSI = { 6, "coarseOFDMFreqEst_sdr",
  "/home/sdruser/git/traviscollins/sdruWiLab/sdruTxRx/private/coarseOFDMFreqEst_sdr.m"
};

static emlrtRSInfo fj_emlrtRSI = { 45, "output",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/scomp/output.m" };

static emlrtRSInfo lj_emlrtRSI = { 44, "strfind",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/strfun/strfind.m" };

static emlrtRSInfo mj_emlrtRSI = { 63, "strfind",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/strfun/strfind.m" };

static emlrtRSInfo nj_emlrtRSI = { 76, "strfind",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/strfun/strfind.m" };

static emlrtRSInfo oj_emlrtRSI = { 85, "strfind",
  "/opt/MATLAB/R2013a/toolbox/eml/lib/matlab/strfun/strfind.m" };
  ...
  mxArray *d, emlrtMCInfo *location)
{
  ...
  pArrays[1] = c;
  pArrays[2] = d;
  return emlrtCallMATLABR2012b(emlrtRootTLSGlobal, 1, &m36, 3, pArrays,
                ...
                int32_T recoveredMessage_size[2])
{
  ...
  char_T cv84[45];
  int32_T i;
  static const char_T cv85[45] = { 'M', 'A', 'T', 'L', 'A', 'B', ':', 's', 'y',
  ...
  char_T cv86[4];
  static const char_T cv87[4] = { 's', 't', 'e', 'p' };

  const mxArray *c_y;
  static const int32_T iv81[2] = { 1, 51 };

  char_T cv88[51];
  static const char_T cv89[51] = { 'M', 'A', 'T', 'L', 'A', 'B', ':', 's', 'y',
    's', 't', 'e', 'm', ':', 'm', 'e', 't', 'h', 'o', 'd', 'C', 'a', 'l', 'l',
  ...
  char_T cv90[5];
  static const char_T cv91[5] = { 's', 'e', 't', 'u', 'p' };

  int32_T errMsg_size[2];
  char_T errMsg_data[1024];
  UsrpErrorCapiEnumT deviceStatus;
  const mxArray *e_y;
  static const int32_T iv83[2] = { 1, 35 };

  char_T cv92[35];
  static const char_T cv93[35] = { 's', 'd', 'r', 'u', ':', 'r', 'e', 'p', 'o',
    'r', 't', 'S', 'D', 'R', 'u', 'S', 't', 'a', 't', 'u', 's', ':', 'N', 'o',
    't', 'C', 'o', 'm', 'p', 'a', 't', 'i', 'b', 'l', 'e' };

  const mxArray *f_y;
  static const int32_T iv84[2] = { 1, 12 };

  char_T cv94[12];
  static const char_T cv95[12] = { '1', '9', '2', '.', '1', '6', '8', '.', '1',
    '0', '.', '2' };

  const mxArray *g_y;
  static const int32_T iv85[2] = { 1, 43 };

  char_T cv96[43];
  static const char_T cv97[43] = { 'r', 'e', 't', 'u', 'r', 'n', 'e', 'd', ' ',
  ...
  static const char_T cv98[35] = { 's', 'd', 'r', 'u', ':', 'r', 'e', 'p', 'o',
    'r', 't', 'S', 'D', 'R', 'u', 'S', 't', 'a', 't', 'u', 's', ':', 'N', 'o',
  ...
  const mxArray *j_y;
  static const int32_T iv88[2] = { 1, 26 };

  char_T cv99[26];
  static const char_T cv100[26] = { 's', 'd', 'r', 'u', ':', 'r', 'e', 'p', 'o',
    'r', 't', 'S', 'D', 'R', 'u', 'S', 't', 'a', 't', 'u', 's', ':', 'B', 'u',
    's', 'y' };

  const mxArray *k_y;
  static const int32_T iv89[2] = { 1, 12 };

  const mxArray *l_y;
  static const int32_T iv90[2] = { 1, 35 };

  static const char_T cv101[35] = { 's', 'd', 'r', 'u', ':', 'r', 'e', 'p', 'o',
  ...
  boolean_T exitg3;
  static const int16_T iv95[8] = { 5120, 1, 1, 1, 1, 1, 1, 1 };
  ...
  static const char_T cv102[7] = { 'T', 'i', 'm', 'e', 'o', 'u', 't' };
  ...
  static const char_T cv103[3] = { 'E', 'O', 'F' };

  int8_T match_out_data[80];
  boolean_T b4;
  int32_T g_tmp_data[77];
  static const char_T cv104[9] = { 'C', 'R', 'C', ' ', 'E', 'r', 'r', 'o', 'r' };
  ...
  while ((exitg2 == FALSE) && (estimate->numProcessed < 3.0)) {
    ...
    if (!obj->isReleased) {
      ...
      y = NULL;
      m17 = mxCreateCharArray(2, iv79);
      for (i = 0; i < 45; i++) {
        cv84[i] = cv85[i];
      }

      emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 45, m17, cv84);
      emlrtAssign(&y, m17);
      b_y = NULL;
      ...
      emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 4, m17, cv86);
      emlrtAssign(&b_y, m17);
    ...
    if (!obj->isInitialized) {
      ...
      if (!obj->isInitialized) {
        ...
        emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 51, m17, cv88);
        emlrtAssign(&c_y, m17);
        d_y = NULL;
        ...
        emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 5, m17, cv90);
        emlrtAssign(&d_y, m17);
      ...
      switch (deviceStatus) {
       case UsrpDriverNotCompatible:
        ...
        if (!(deviceStatus == UsrpDriverNotCompatible)) {
          ...
          emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 35, m17, cv92);
          emlrtAssign(&e_y, m17);
          f_y = NULL;
          ...
          emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 12, m17, cv94);
          emlrtAssign(&f_y, m17);
          g_y = NULL;
          ...
          emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 43, m17, cv96);
          emlrtAssign(&g_y, m17);
       ...
       case UsrpDriverBusy:
        ...
        if (!(deviceStatus == UsrpDriverBusy)) {
          ...
          emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 26, m17, cv99);
          emlrtAssign(&j_y, m17);
          k_y = NULL;
    ...
    if (obj->TunablePropsChanged) {
      ...
      for (i = 0; i < 4; i++) {
        for (i14 = 0; i14 < 4; i14++) {
          value[i14] = obj->tunablePropertyChanged[i14];
        }

        value[i] = FALSE;
        emlrtPushRtStackR2012b(&q_emlrtRSI, emlrtRootTLSGlobal);
        for (i14 = 0; i14 < 4; i14++) {
          obj->tunablePropertyChanged[i14] = value[i14];
        }
    ...
    if ((P.re == 0.0) && (P.im == 0.0)) {
      ...
      if (!b_obj->isInitialized) {
        ...
        emlrtPushRtStackR2012b(&p_emlrtRSI, emlrtRootTLSGlobal);
        for (i14 = 0; i14 < 8; i14++) {
          b_obj->inputVarSize1[i14] = (uint32_T)b_value[i14];
        }
      ...
      while ((exitg3 == FALSE) && (match_idx < 8)) {
        if (b_obj->inputVarSize1[match_idx] != (uint32_T)iv95[match_idx]) {
          emlrtPushRtStackR2012b(&p_emlrtRSI, emlrtRootTLSGlobal);
          for (i14 = 0; i14 < 8; i14++) {
            b_obj->inputVarSize1[i14] = (uint32_T)b_value[i14];
          }
      ...
      for (i14 = 0; i14 < 16; i14++) {
        rx_shortPreambleOFDM_data[i14].re = rx_shortPreambleOFDM[i14].re;
        rx_shortPreambleOFDM_data[i14].im = -rx_shortPreambleOFDM[i14].im;
      }
      ...
      if (b3) {
        ...
        for (i14 = 0; i14 < 1280; i14++) {
          c_tmp_data[i14] = (int16_T)(1 + i14);
        }

        for (i14 = 0; i14 < 1280; i14++) {
          numPeaks = preambleEstimatedLocation + (real_T)c_tmp_data[i14];
        ...
        for (i14 = 0; i14 < 1280; i14++) {
          d_tmp_data[i14] = (int32_T)(preambleEstimatedLocation + (real_T)
            c_tmp_data[i14]);
        }
        ...
        for (i14 = 0; i14 < 1280; i14++) {
          e_tmp_data[i14] = (int32_T)(preambleEstimatedLocation + (real_T)
            c_tmp_data[i14]);
        }

        for (i14 = 0; i14 < 32; i14++) {
          buffer_data[i14].re = SD->f3.buffer[d_tmp_data[i14] - 1].re *
            SD->f3.buffer[e_tmp_data[32 + i14] - 1].re - -SD->
            f3.buffer[d_tmp_data[i14] - 1].im * SD->f3.buffer[e_tmp_data[32 +
            i14] - 1].im;
          buffer_data[i14].im = SD->f3.buffer[d_tmp_data[i14] - 1].re *
            SD->f3.buffer[e_tmp_data[32 + i14] - 1].im + -SD->
            f3.buffer[d_tmp_data[i14] - 1].im * SD->f3.buffer[e_tmp_data[32 +
            i14] - 1].re;
        }
        ...
        for (i14 = 0; i14 < 1280; i14++) {
          SD->f3.buffer_data[i14] = SD->f3.buffer[d_tmp_data[i14] - 1];
        }
        ...
        RHard_size[0] = 563;
        for (i14 = 0; i14 < 563; i14++) {
          RHard_data[i14] = (RLinear[i14].re < 0.0);
        }
        ...
        for (i14 = 0; i14 < 563; i14++) {
          b_RHard_data[i14] = (int8_T)RHard_data[i14];
        }

        for (i14 = 0; i14 < 563; i14++) {
          messageBits_data[(match_idx + messageBits_size[0] * i14) - 1] =
            b_RHard_data[i14];
        }
      }
      ...
      if (numBuffersProcessed > 48) {
        ...
        for (i14 = 0; i14 < 7; i14++) {
          recoveredMessage_data[i14] = cv102[i14];
        }
  ...
  while (numBuffersProcessed <= (int32_T)estimate->numProcessed - 1) {
    ...
    c_obj = ObjDetect;
    for (i14 = 0; i14 < 563; i14++) {
      RHard_data[i14] = (messageBits_data[((int32_T)(1.0 + (real_T)
        numBuffersProcessed) + messageBits_size[0] * i14) - 1] > 0.0);
    }
    ...
    if (!c_obj->isInitialized) {
      ...
      emlrtPushRtStackR2012b(&p_emlrtRSI, emlrtRootTLSGlobal);
      for (i14 = 0; i14 < 8; i14++) {
        c_obj->inputVarSize1[i14] = (uint32_T)c_value[i14];
      }
    ...
    while ((exitg1 == FALSE) && (match_idx < 8)) {
      if (c_obj->inputVarSize1[match_idx] != (uint32_T)iv100[match_idx]) {
        emlrtPushRtStackR2012b(&p_emlrtRSI, emlrtRootTLSGlobal);
        for (i14 = 0; i14 < 8; i14++) {
          c_obj->inputVarSize1[i14] = (uint32_T)inputSize[i14];
        }
    ...
    if (!b_leftoverBits) {
      ...
      for (i14 = 0; i14 < 560; i14++) {
        b_varargout_1_data[i14] = (varargout_1_data[i14] > 0);
      }
      ...
      match_idx = Phat_size[0];
      for (i14 = 0; i14 < match_idx; i14++) {
        messageEnd_data[i14] = f_tmp_data[i14];
      }

      for (i14 = 0; i14 < 2; i14++) {
        iv101[i14] = (int8_T)messageEnd_size[i14];
      }

      match_idx = iv101[1];
      for (i14 = 0; i14 < match_idx; i14++) {
        numPeaks = muDoubleScalarFloor(messageEnd_data[i14]);
        ...
        if (numPeaks < 0.0) {
          message_data[i14] = (int8_T)-(int8_T)(uint8_T)-numPeaks;
        } else {
          message_data[i14] = (int8_T)(uint8_T)numPeaks;
        }
      }
      ...
      if (iv101[1] == 0) {
        ...
        for (i14 = 0; i14 < match_idx; i14++) {
          messageEnd_data[i14] = match_out_data[i14];
        }
      ...
      if (!(messageEnd_size[1] == 0)) {
        if (1.0 > messageEnd_data[0] - 1.0) {
          ...
          i14 = iv101[1];
          emlrtDynamicBoundsCheckFastR2012b(1, 1, i14, &o_emlrtBCI,
            emlrtRootTLSGlobal);
          i14 = iv101[1];
          bitNumber = (int32_T)messageEnd_data[0] - 1;
          match_idx = emlrtDynamicBoundsCheckFastR2012b(bitNumber, 1, i14,
        ...
        emlrtDimSizeGeqCheckFastR2012b(80, match_idx, &d_emlrtECI,
          emlrtRootTLSGlobal);
        for (i14 = 0; i14 < match_idx; i14++) {
          g_tmp_data[i14] = 1 + i14;
        }

        recoveredMessage_size[0] = 1;
        recoveredMessage_size[1] = match_idx;
        for (i14 = 0; i14 < match_idx; i14++) {
          recoveredMessage_data[i14] = message_data[g_tmp_data[i14] - 1];
        }
      }
    } else {
      ...
      for (i14 = 0; i14 < 9; i14++) {
        recoveredMessage_data[i14] = cv104[i14];
      }
    }
