...
static emlrtRSInfo lg_emlrtRSI = { 31, "xcorr",
  "/opt/MATLAB/R2013a/toolbox/signal/eml/xcorr.m" };

static emlrtRSInfo mg_emlrtRSI = { 94, "xcorr",
  "/opt/MATLAB/R2013a/toolbox/signal/eml/xcorr.m" };

static emlrtRSInfo ng_emlrtRSI = { 101, "xcorr",
  "/opt/MATLAB/R2013a/toolbox/signal/eml/xcorr.m" };

static emlrtRSInfo og_emlrtRSI = { 21, "colon",
  ...
  c_size[1])
{
  ...
  for (i = 0; i < 2461; i++) {
    ...
    i20 = (int32_T)muDoubleScalarMin((1.0 + (real_T)i) - 1215.0, 1231.0) -
      jstart;
    for (j = 0; j <= i20; j++) {
      b_j = jstart + j;
      i21 = (b_j - i) + 1230;
      emlrtDynamicBoundsCheckFastR2012b(i21, 1, 16, &s_emlrtBCI,
        emlrtRootTLSGlobal);
                      ...
                      creal_T c_data[2461], int32_T c_size[1])
{
  ...
  for (i = 0; i < 2461; i++) {
    ...
    for (j = -1; j + 1 <= i18; j++) {
      b_j = jstart + j;
      i19 = (b_j - i) + 1231;
      emlrtDynamicBoundsCheckFastR2012b(i19, 1, 16, &s_emlrtBCI,
        emlrtRootTLSGlobal);
      i19 = b_j + 1;
      emlrtDynamicBoundsCheckFastR2012b(i19, 1, 1231, &r_emlrtBCI,
        emlrtRootTLSGlobal);
...
void b_xcorr(const real_T arg1_data[1231], real_T C_data[2461], int32_T C_size[1])
{
  ...
  if (!n_too_large) {
    ...
    y = NULL;
    m22 = mxCreateCharArray(2, iv106);
    for (i = 0; i < 21; i++) {
      cv113[i] = cv114[i];
    }

    emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 21, m22, cv113);
    emlrtAssign(&y, m22);
           ...
           C_data[2461], int32_T C_size[1])
{
  ...
  int32_T n;
  const mxArray *y;
  static const int32_T iv105[2] = { 1, 21 };

  const mxArray *m21;
  char_T cv111[21];
  int32_T i;
  static const char_T cv112[21] = { 'C', 'o', 'd', 'e', 'r', ':', 'M', 'A', 'T',
    'L', 'A', 'B', ':', 'p', 'm', 'a', 'x', 's', 'i', 'z', 'e' };
  ...
  if (!n_too_large) {
    ...
    emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 21, m21, cv111);
    emlrtAssign(&y, m21);
    b_error(b_message(y, &t_emlrtMCI), &u_emlrtMCI);
    emlrtPopRtStackR2012b(&sg_emlrtRSI, emlrtRootTLSGlobal);
  }
