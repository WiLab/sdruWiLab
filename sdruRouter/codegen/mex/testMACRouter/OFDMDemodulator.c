...
static emlrtRSInfo gs_emlrtRSI = { 152, "OFDMDemodulator",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/OFDMDemodulator.m" };

static emlrtRSInfo hs_emlrtRSI = { 162, "OFDMDemodulator",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/OFDMDemodulator.m" };

static emlrtRSInfo is_emlrtRSI = { 168, "OFDMDemodulator",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/OFDMDemodulator.m" };

static emlrtRSInfo js_emlrtRSI = { 172, "OFDMDemodulator",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/OFDMDemodulator.m" };

static emlrtRSInfo ks_emlrtRSI = { 171, "OFDMDemodulator",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/OFDMDemodulator.m" };

static emlrtRSInfo ls_emlrtRSI = { 14, "fft",
  "/Applications/MATLAB_R2013b.app/toolbox/eml/lib/matlab/datafun/fft.m" };

static emlrtRSInfo qs_emlrtRSI = { 16, "fftshift",
  "/Applications/MATLAB_R2013b.app/toolbox/eml/lib/matlab/datafun/fftshift.m" };

static emlrtRSInfo vs_emlrtRSI = { 22, "reshape",
  "/Applications/MATLAB_R2013b.app/toolbox/eml/lib/matlab/elmat/reshape.m" };

static emlrtRSInfo ws_emlrtRSI = { 41, "eml_assert_valid_size_arg",
  "/Applications/MATLAB_R2013b.app/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m"
};

static emlrtRSInfo tt_emlrtRSI = { 176, "OFDMDemodulator",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/OFDMDemodulator.m" };
...
static emlrtBCInfo gb_emlrtBCI = { 1, 64, 171, 28, "postShift",
  "OFDMDemodulator",
...
static emlrtBCInfo hb_emlrtBCI = { 1, 768, 171, 28, "postShift",
  "OFDMDemodulator",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/OFDMDemodulator.m", 0 };

static emlrtRSInfo tv_emlrtRSI = { 42, "eml_assert_valid_size_arg",
  "/Applications/MATLAB_R2013b.app/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m"
};

static emlrtRSInfo wv_emlrtRSI = { 57, "eml_assert_valid_size_arg",
  "/Applications/MATLAB_R2013b.app/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m"
};
  ...
  const creal_T x[64], emxArray_creal_T *varargout_1)
{
  ...
  const mxArray *m24;
  char_T cv128[21];
  static const char_T cv129[21] = { 'C', 'o', 'd', 'e', 'r', ':', 'M', 'A', 'T',
    'L', 'A', 'B', ':', 'p', 'm', 'a', 'x', 's', 'i', 'z', 'e' };

  int32_T sz[3];
  emxArray_creal_T *b_y;
  const mxArray *c_y;
  static const int32_T iv115[2] = { 1, 40 };

  char_T cv130[40];
  static const char_T cv131[40] = { 'C', 'o', 'd', 'e', 'r', ':', 'M', 'A', 'T',
  ...
  if (2.147483647E+9 >= tmp_re) {
    ...
    y = NULL;
    m24 = mxCreateCharArray(2, iv114);
    for (i = 0; i < 21; i++) {
      cv128[i] = cv129[i];
    }

    emlrtInitCharArrayR2013a(&b_st, 21, m24, cv128);
    emlrtAssign(&y, m24);
    c_st.site = &xs_emlrtRSI;
  ...
  if (c_x->size[0] == sz[0]) {
    ...
    emlrtInitCharArrayR2013a(&st, 40, m24, cv130);
    emlrtAssign(&c_y, m24);
    b_st.site = &ss_emlrtRSI;
...
void b_OFDMDemodulator_stepImpl(testMACRouterStackData *SD, const emlrtStack *sp,
  const OFDMDemodulator_1 *obj, const creal_T x[960], emxArray_creal_T
  *varargout_1, creal_T varargout_2[48])
{
  ...
  int32_T exitg1;
  const mxArray *y;
  static const int32_T iv116[2] = { 1, 57 };

  const mxArray *m25;
  char_T cv132[57];
  static const char_T cv133[57] = { 'C', 'o', 'd', 'e', 'r', ':', 't', 'o', 'o',
  ...
  const mxArray *f_y;
  static const int32_T iv118[2] = { 1, 40 };

  char_T cv136[40];
  static const char_T cv137[40] = { 'C', 'o', 'd', 'e', 'r', ':', 'M', 'A', 'T',
    'L', 'A', 'B', ':', 'g', 'e', 't', 'R', 'e', 's', 'h', 'a', 'p', 'e', 'D',
    'i', 'm', 's', '_', 'n', 'o', 't', 'S', 'a', 'm', 'e', 'N', 'u', 'm', 'e',
    'l' };

  creal_T d_x[48];
  static const int16_T iv119[48] = { 11, 25, 39, 53, 75, 89, 103, 117, 139, 153,
  ...
  for (chanStart = 0; chanStart < 706; chanStart += 64) {
    ...
    for (i = 0; i < 63; i++) {
      ...
      SD->u1.f1.postFFT[i2] = SD->u1.f1.inputIn3D[(ix % 64 + 80 * b_ix) + 16];
      i2 = 64;
      overflow = TRUE;
      while (overflow) {
        if (i2 >= 0) {
    ...
    SD->u1.f1.postFFT[i2] = SD->u1.f1.inputIn3D[(ix % 64 + 80 * c_ix) + 16];
    ix++;
    for (i = chanStart; i <= chanStart + 62; i += 2) {
      tmp_re = SD->u1.f1.postFFT[i + 1].re;
      tmp_im = SD->u1.f1.postFFT[i + 1].im;
      SD->u1.f1.postFFT[i + 1].re = SD->u1.f1.postFFT[i].re - SD->
        u1.f1.postFFT[i + 1].re;
      SD->u1.f1.postFFT[i + 1].im = SD->u1.f1.postFFT[i].im - SD->
        u1.f1.postFFT[i + 1].im;
      SD->u1.f1.postFFT[i].re += tmp_re;
      SD->u1.f1.postFFT[i].im += tmp_im;
    }
    ...
    while (k > 0) {
      ...
      while (i < ihi) {
        i2 = i + ib;
        tmp_re = SD->u1.f1.postFFT[i2].re;
        tmp_im = SD->u1.f1.postFFT[i2].im;
        SD->u1.f1.postFFT[i + ib].re = SD->u1.f1.postFFT[i].re -
          SD->u1.f1.postFFT[i2].re;
        SD->u1.f1.postFFT[i + ib].im = SD->u1.f1.postFFT[i].im -
          SD->u1.f1.postFFT[i2].im;
        SD->u1.f1.postFFT[i].re += tmp_re;
        SD->u1.f1.postFFT[i].im += tmp_im;
        i += iDelta2;
      }
      ...
      for (i1 = k; i1 < 32; i1 += k) {
        ...
        ihi = i2 + iheight;
        while (i < ihi) {
          tmp_re = dv10[i1] * SD->u1.f1.postFFT[i + ib].re - dv9[i1] *
            SD->u1.f1.postFFT[i + ib].im;
          tmp_im = dv10[i1] * SD->u1.f1.postFFT[i + ib].im + dv9[i1] *
            SD->u1.f1.postFFT[i + ib].re;
          SD->u1.f1.postFFT[i + ib].re = SD->u1.f1.postFFT[i].re - tmp_re;
          SD->u1.f1.postFFT[i + ib].im = SD->u1.f1.postFFT[i].im - tmp_im;
          SD->u1.f1.postFFT[i].re += tmp_re;
          SD->u1.f1.postFFT[i].im += tmp_im;
          i += iDelta2;
        }
  ...
  for (i = 0; i < 12; i++) {
    ...
    ib = i1 + 32;
    for (k = 0; k < 32; k++) {
      tmp_re = SD->u1.f1.postFFT[i1].re;
      tmp_im = SD->u1.f1.postFFT[i1].im;
      SD->u1.f1.postFFT[i1] = SD->u1.f1.postFFT[ib];
      SD->u1.f1.postFFT[ib].re = tmp_re;
      SD->u1.f1.postFFT[ib].im = tmp_im;
      c_st.site = &gd_emlrtRSI;
      i1++;
      c_st.site = &hd_emlrtRSI;
      ib++;
  ...
  for (ib = 0; ib < i2; ib++) {
    ...
    c_x->data[ib].re = SD->u1.f1.postFFT[emlrtDynamicBoundsCheckFastR2012b(i1, 1,
      768, &hb_emlrtBCI, &st) - 1].re;
    tmp_re = obj->pDataLinearIndices->data[ib];
    i1 = (int32_T)emlrtIntegerCheckFastR2012b(tmp_re, &d_emlrtDCI, &st);
    c_x->data[ib].im = SD->u1.f1.postFFT[emlrtDynamicBoundsCheckFastR2012b(i1, 1,
      768, &hb_emlrtBCI, &st) - 1].im;
  }
  ...
  if (overflow) {
    ...
    emlrtInitCharArrayR2013a(&b_st, 57, m25, cv132);
    emlrtAssign(&y, m25);
    b_y = NULL;
    m25 = mxCreateNumericMatrix(1, 1, mxINT32_CLASS, mxREAL);
    *(int32_T *)mxGetData(m25) = MIN_int32_T;
    emlrtAssign(&b_y, m25);
    c_y = NULL;
    m25 = mxCreateNumericMatrix(1, 1, mxINT32_CLASS, mxREAL);
    *(int32_T *)mxGetData(m25) = MAX_int32_T;
    emlrtAssign(&c_y, m25);
    c_st.site = &ws_emlrtRSI;
  ...
  if (2.147483647E+9 >= tmp_re) {
    ...
    d_y = NULL;
    m25 = mxCreateCharArray(2, iv117);
    for (i = 0; i < 21; i++) {
      cv134[i] = cv135[i];
    }

    emlrtInitCharArrayR2013a(&b_st, 21, m25, cv134);
    emlrtAssign(&d_y, m25);
    c_st.site = &xs_emlrtRSI;
    d_st.site = &wv_emlrtRSI;
  ...
  if (c_x->size[0] == sz[0] * 12) {
    ...
    emlrtInitCharArrayR2013a(&st, 40, m25, cv136);
    emlrtAssign(&f_y, m25);
    b_st.site = &ss_emlrtRSI;
    e_st.site = &vv_emlrtRSI;
  ...
  st.site = &tt_emlrtRSI;
  for (ib = 0; ib < 48; ib++) {
    d_x[ib] = SD->u1.f1.postFFT[iv119[ib]];
  }
