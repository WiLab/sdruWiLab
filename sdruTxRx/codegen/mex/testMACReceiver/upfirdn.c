...
static emlrtRSInfo fu_emlrtRSI = { 147, "upfirdn",
  "/Applications/MATLAB_R2013b.app/toolbox/signal/eml/upfirdn.m" };

static emlrtRSInfo gu_emlrtRSI = { 150, "upfirdn",
  "/Applications/MATLAB_R2013b.app/toolbox/signal/eml/upfirdn.m" };

static emlrtRSInfo hu_emlrtRSI = { 151, "upfirdn",
  "/Applications/MATLAB_R2013b.app/toolbox/signal/eml/upfirdn.m" };

/* Function Definitions */
void upfirdn(testMACReceiverStackData *SD, const emlrtStack *sp, const creal_T
             x_in[48], creal_T y_out[3336])
{
  ...
  st.site = &gu_emlrtRSI;
  g_SystemCore_step(&st, &s, b_x_in, SD->u1.f2.y);
  st.site = &hu_emlrtRSI;
  SystemCore_reset(&st, &s);
  for (i24 = 0; i24 < 12; i24++) {
    memcpy(&y_out[278 * i24], &SD->u1.f2.y[288 * i24], 278U * sizeof(creal_T));
  }
