function [ObjAGC, ObjSDRuTransmitter, ObjDetect, ObjPreambleDemod, ObjDataDemod,...
          estimate, tx, timeoutDuration, messageBits, desiredSamplingFrequency, destNodeID,originNodeID, inputPayloadMessage] = CreateTXRX_TX
