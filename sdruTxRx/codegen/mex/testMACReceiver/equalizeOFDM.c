...
static emlrtRSInfo go_emlrtRSI = { 20, "eml_scalar_abs",
  "/Applications/MATLAB_R2013b.app/toolbox/eml/lib/matlab/elfun/eml_scalar_abs.m"
};

static emlrtRSInfo lp_emlrtRSI = { 51, "power",
  "/Applications/MATLAB_R2013b.app/toolbox/eml/lib/matlab/ops/power.m" };

static emlrtRSInfo cs_emlrtRSI = { 16, "equalizeOFDM",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/private/equalizeOFDM.m" };

static emlrtRSInfo ds_emlrtRSI = { 17, "equalizeOFDM",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/private/equalizeOFDM.m" };

static emlrtRSInfo es_emlrtRSI = { 21, "equalizeOFDM",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/private/equalizeOFDM.m" };

static emlrtRSInfo fs_emlrtRSI = { 28, "equalizeOFDM",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/private/equalizeOFDM.m" };

static emlrtRSInfo gs_emlrtRSI = { 31, "equalizeOFDM",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/private/equalizeOFDM.m" };

static emlrtRSInfo hs_emlrtRSI = { 42, "equalizeOFDM",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/private/equalizeOFDM.m" };

static emlrtRSInfo js_emlrtRSI = { 141, "OFDMDemodulator",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/OFDMDemodulator.m" };

static emlrtRSInfo ft_emlrtRSI = { 59, "equalizeOFDM",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/private/equalizeOFDM.m" };

static emlrtRSInfo gt_emlrtRSI = { 62, "equalizeOFDM",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/private/equalizeOFDM.m" };

static emlrtRSInfo ht_emlrtRSI = { 63, "equalizeOFDM",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/private/equalizeOFDM.m" };

static emlrtRSInfo it_emlrtRSI = { 64, "equalizeOFDM",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/private/equalizeOFDM.m" };

static emlrtRSInfo wt_emlrtRSI = { 136, "OFDMDemodulator",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/OFDMDemodulator.m" };

static emlrtRSInfo au_emlrtRSI = { 72, "equalizeOFDM",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/private/equalizeOFDM.m" };

static emlrtRSInfo bu_emlrtRSI = { 75, "equalizeOFDM",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/private/equalizeOFDM.m" };

static emlrtRSInfo cu_emlrtRSI = { 77, "equalizeOFDM",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/private/equalizeOFDM.m" };

static emlrtRSInfo du_emlrtRSI = { 80, "equalizeOFDM",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/private/equalizeOFDM.m" };
...
static emlrtBCInfo mb_emlrtBCI = { -1, -1, 58, 7, "R", "equalizeOFDM",
  "/Volumes/git/traviscollins/sdruWiLab/sdruTxRx/private/equalizeOFDM.m", 0 };

/* Function Declarations */
static void b_equalizeOFDM(testMACReceiverStackData *SD, const emlrtStack *sp,
  ...
  emxArray_creal_T *Rraw)
{
  ...
  const mxArray *y;
  static const int32_T iv204[2] = { 1, 45 };

  const mxArray *m52;
  char_T cv253[45];
  int32_T i;
  static const char_T cv254[45] = { 'M', 'A', 'T', 'L', 'A', 'B', ':', 's', 'y',
    's', 't', 'e', 'm', ':', 'm', 'e', 't', 'h', 'o', 'd', 'C', 'a', 'l', 'l',
    'e', 'd', 'W', 'h', 'e', 'n', 'R', 'e', 'l', 'e', 'a', 's', 'e', 'd', 'C',
    'o', 'd', 'e', 'g', 'e', 'n' };

  const mxArray *b_y;
  static const int32_T iv205[2] = { 1, 4 };

  char_T cv255[4];
  static const char_T cv256[4] = { 's', 't', 'e', 'p' };

  const mxArray *c_y;
  static const int32_T iv206[2] = { 1, 51 };

  char_T cv257[51];
  static const char_T cv258[51] = { 'M', 'A', 'T', 'L', 'A', 'B', ':', 's', 'y',
    's', 't', 'e', 'm', ':', 'm', 'e', 't', 'h', 'o', 'd', 'C', 'a', 'l', 'l',
    'e', 'd', 'W', 'h', 'e', 'n', 'L', 'o', 'c', 'k', 'e', 'd', 'R', 'e', 'l',
    'e', 'a', 's', 'e', 'd', 'C', 'o', 'd', 'e', 'g', 'e', 'n' };

  const mxArray *d_y;
  static const int32_T iv207[2] = { 1, 5 };

  char_T cv259[5];
  static const char_T cv260[5] = { 's', 'e', 't', 'u', 'p' };

  int8_T fullGrid[64];
  int32_T k;
  static const int8_T iv208[11] = { 0, 1, 2, 3, 4, 5, 59, 60, 61, 62, 63 };
  ...
  const mxArray *e_y;
  static const int32_T iv209[2] = { 1, 45 };

  const mxArray *f_y;
  static const int32_T iv210[2] = { 1, 4 };

  const mxArray *g_y;
  static const int32_T iv211[2] = { 1, 51 };

  const mxArray *h_y;
  static const int32_T iv212[2] = { 1, 5 };
  ...
  static const int16_T iv217[48] = { 11, 25, 39, 53, 75, 89, 103, 117, 139, 153,
  ...
  int32_T ia;
  int32_T iv218[3];
  static const int8_T iv219[3] = { 48, 12, 1 };
  ...
  if (!obj->isReleased) {
    ...
    y = NULL;
    m52 = mxCreateCharArray(2, iv204);
    for (i = 0; i < 45; i++) {
      cv253[i] = cv254[i];
    }

    emlrtInitCharArrayR2013a(&st, 45, m52, cv253);
    emlrtAssign(&y, m52);
    b_y = NULL;
    m52 = mxCreateCharArray(2, iv205);
    for (i = 0; i < 4; i++) {
      cv255[i] = cv256[i];
    }

    emlrtInitCharArrayR2013a(&st, 4, m52, cv255);
    emlrtAssign(&b_y, m52);
  ...
  if (!obj->isInitialized) {
    ...
    if (!obj->isInitialized) {
      ...
      c_y = NULL;
      m52 = mxCreateCharArray(2, iv206);
      for (i = 0; i < 51; i++) {
        cv257[i] = cv258[i];
      }

      emlrtInitCharArrayR2013a(&b_st, 51, m52, cv257);
      emlrtAssign(&c_y, m52);
      d_y = NULL;
      m52 = mxCreateCharArray(2, iv207);
      for (i = 0; i < 5; i++) {
        cv259[i] = cv260[i];
      }

      emlrtInitCharArrayR2013a(&b_st, 5, m52, cv259);
      emlrtAssign(&d_y, m52);
  ...
  for (k = 0; k < 53; k++) {
    ii = b_R->size[0];
    i = 1 + k;
    emlrtDynamicBoundsCheckFastR2012b(i, 1, ii, &mb_emlrtBCI, &st);
  }
  ...
  emlrtSizeEqCheckNDR2012b(iv218, b_Rraw, &v_emlrtECI, sp);
...
void equalizeOFDM(testMACReceiverStackData *SD, const emlrtStack *sp, const
