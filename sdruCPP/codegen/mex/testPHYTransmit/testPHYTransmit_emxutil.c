...
{
  pStruct->dataSubcarrierIndexies.size[0] = 0;
  pStruct->dataSubcarrierIndexies.size[1] = 0;
}
...
{
  pStruct->pilotEqGains.size[0] = 0;
  pStruct->pilotEqGains.size[1] = 0;
  pStruct->preambleEqGains.size[0] = 0;
  pStruct->message.size[0] = 0;
}
...
/* End of code generation (testPHYTransmit_emxutil.c) */
