...
static emlrtRSInfo eb_emlrtRSI = { 168, "OFDMModulator",
  "/Users/travis/Git/sdruWiLab/sdruTxRx/OFDMModulator.m" };

static emlrtRSInfo fb_emlrtRSI = { 182, "OFDMModulator",
  "/Users/travis/Git/sdruWiLab/sdruTxRx/OFDMModulator.m" };
  ...
  OFDMModulator_1 *object)
{
  ...
  f_st.site = &ph_emlrtRSI;
  g_st.site = &qh_emlrtRSI;
  for (i = 0; i < 4; i++) {
