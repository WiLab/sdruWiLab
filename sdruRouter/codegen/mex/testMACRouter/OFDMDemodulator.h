...
extern void b_OFDMDemodulator_stepImpl(testMACRouterStackData *SD, const emlrtStack *sp, const OFDMDemodulator_1 *obj, const creal_T x[960], emxArray_creal_T *varargout_1, creal_T varargout_2[48]);
#endif
