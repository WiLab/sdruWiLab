...
static emlrtRSInfo mf_emlrtRSI = { 7, "OFDMletters2bits",
...
static emlrtBCInfo c_emlrtBCI = { -1, -1, 11, 27, "letter", "OFDMletters2bits",
  "/Users/travis/Git/sdruWiLab/sdruTxRx/private/OFDMletters2bits.m", 0 };

static emlrtRSInfo an_emlrtRSI = { 11, "OFDMletters2bits",
  "/Users/travis/Git/sdruWiLab/sdruTxRx/private/OFDMletters2bits.m" };
  ...
  emlrtMCInfo *location)
{
  ...
  const mxArray *m27;
  pArray = b;
  return emlrtCallMATLABR2012b(sp, 1, &m27, 1, &pArray, "str2double", TRUE,
    location);
}
...
void OFDMletters2bits(const emlrtStack *sp, const char_T str[80], real_T f[560])
{
  ...
  for (firstcol = 0; firstcol < 80; firstcol++) {
    for (i = 0; i < 7; i++) {
      i1 = 1 + i;
      emlrtDynamicBoundsCheckFastR2012b(i1, 1, bits_size_idx_1, &c_emlrtBCI, sp);
      y = NULL;
...
void b_OFDMletters2bits(const emlrtStack *sp, real_T f[560])
{
  ...
  int32_T i13;
  int32_T firstcol;
  static const char_T cv73[80] = { 'L', 'i', 'v', 'e', ' ', 'l', 'o', 'n', 'g',
